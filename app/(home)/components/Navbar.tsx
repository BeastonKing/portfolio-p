...
export default function Navbar() {
    ...
    return <nav className=' py-10 flex justify-between items-center'>
        <h1 className=' text-2xl font-bold underline underline-offset-8 decoration-green-500 -rotate-2'>Bintang ⭐</h1>
        <div className=' flex items-center gap-5'>
            {socials.map((social, idx) => {
                const Icon = social.icon;

                return <Link href={social.link} key={idx} aria-label={social.label}>
